...
class Messages extends Component {
    ...
    render () {
        ...
        <Message 
        msg={ {
          //  usrName: messageId.sender ? messageId.sender : user, 
            // строка ниже меняет класс у сообщения и стиль, если это робот
            clsName: messages[messageId].sender === 'bot'? 'bot-cloud-msg' : 'msg-cloud', 
            ltr: messages[messageId].sender === 'bot'? 'msg-right' : 'msg-left' , 
            // rtl: messageId.sender === 'it'? 'msg-left' : '', 
          //  msgBody: messageId.body
        } }
        key={ messageId }
            ...
            <div className="text-field-full">
                ...
                <footer>
                    ...
                    <TextField 
                        ...
                        style={{width: 100 + '%'}} />
                    <Fab  className="btn-send-msg" style={{width: 40 + 'px', height: 40 + 'px', backgroundColor: 'blue', color: 'white'}} onClick={ () => this.handleSendMessage(this.state.input, 'it') }>
                        <SendIcon />
                    </Fab> 
                    </div>
                </footer>
